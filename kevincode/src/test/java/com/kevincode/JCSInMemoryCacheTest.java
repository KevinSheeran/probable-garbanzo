...
import com.kevincode.service.JCSInMemoryCache;
...
public class JCSInMemoryCacheTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JCSInMemoryCacheTest jcsInMemoryCacheTest = new JCSInMemoryCacheTest();

        System.out.println("\n\n==========Test1: jcsTestAddRemoveObjects ==========");
        jcsInMemoryCacheTest.jcsTestAddRemoveObjects();
//        System.out.println("\n\n==========Test2: jcsTestExpiredCacheObjects ==========");
//        jcsInMemoryCacheTest.jcsTestExpiredCacheObjects();
//        System.out.println("\n\n==========Test3: jcsTestObjectsCleanupTime ==========");
//        jcsInMemoryCacheTest.jcsTestObjectsCleanupTime();
    }
    ...
    private void jcsTestAddRemoveObjects() {
        ...
        // maxItems = 6
        JCSInMemoryCache<String, String> cache = new JCSInMemoryCache<String, String>(200, 500, 6);
    ...
    private void jcsTestExpiredCacheObjects() throws InterruptedException {
        ...
        // maxItems = 10
        JCSInMemoryCache<String, String> cache = new JCSInMemoryCache<String, String>(1, 1, 10);
    ...
    private void jcsTestObjectsCleanupTime() throws InterruptedException {
        ...
        JCSInMemoryCache<String, String> cache = new JCSInMemoryCache<String, String>(100, 100, 500000);
